...
[new GeoPoint(0, 0)];
ArrayUtils.create(1, () => Vec3Math.create());
ArrayUtils.create(3, () => new GeoPoint(0, 0));
ArrayUtils.create(1, () => new GeoCircle(Vec3Math.create(), 0));
ArrayUtils.create(4, () => Vec3Math.create());
ArrayUtils.create(2, () => new GeoCircle(Vec3Math.create(), 0));
ArrayUtils.create(5, () => Vec3Math.create());
ArrayUtils.create(3, () => new GeoCircle(Vec3Math.create(), 0));
[Vec3Math.create(), Vec3Math.create()];
ArrayUtils.create(4, () => Vec3Math.create());
ArrayUtils.create(10, () => new GeoPoint(0, 0));
ArrayUtils.create(1, () => new GeoCircle(Vec3Math.create(), 0));
[Vec3Math.create(), Vec3Math.create()];
ArrayUtils.create(1, () => new GeoCircle(Vec3Math.create(), 0));
ArrayUtils.create(4, () => Vec3Math.create());
ArrayUtils.create(1, () => new GeoPoint(0, 0));
ArrayUtils.create(2, () => new GeoCircle(Vec3Math.create(), 0));
ArrayUtils.create(8, () => Vec3Math.create());
ArrayUtils.create(5, () => new GeoCircle(Vec3Math.create(), 0));
ArrayUtils.create(5, () => Vec3Math.create());
ArrayUtils.create(4, () => new GeoCircle(Vec3Math.create(), 0));
ArrayUtils.create(6, () => Vec3Math.create());
[Vec3Math.create(), Vec3Math.create()];
[
    LegType.AF,
    LegType.RF,

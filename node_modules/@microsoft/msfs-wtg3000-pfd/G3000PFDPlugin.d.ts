...
import { DisplayPaneIndex, DisplayPaneViewFactory, FlightPlanStore, G3000NavIndicators, G3000Plugin, G3000PluginBinder, PfdIndex, WeightBalancePaneViewModule } from '@microsoft/msfs-wtg3000-common';
...
export interface G3000PfdPlugin extends G3000Plugin<G3000PfdPluginBinder> {
     ...
     */
    renderToPfdInstruments(pfdIndex: PfdIndex, displayPaneIndex: DisplayPaneIndex.LeftPfdInstrument | DisplayPaneIndex.RightPfdInstrument, isInSplitMode: Subscribable<boolean>, declutter: Subscribable<boolean>): VNode | null;
    /**
 ...
 */
export declare abstract class AbstractG3000PfdPlugin extends AvionicsPlugin<G3000PfdPluginBinder> implements G3000PfdPlugin {
    /** @inheritdoc */
    onInstalled(): void;
    /** @inheritdoc */
    onInit(): void;
...
//# sourceMappingURL=G3000PFDPlugin.d.ts.map
 ...
 */
export declare enum ToldRunwaySurfaceCondition {
    Dry = "Dry",
    Wet = "Wet"
}
/**
 ...
 */
export declare enum ToldLimitExceedance {
    FieldLength = 1,
    Weight = 2,
    PressureAltitudeLow = 4,
    PressureAltitudeHigh = 8,
    TemperatureLow = 16,
    TemperatureHigh = 32,
    Headwind = 64,
    Tailwind = 128,
...
export {};
//# sourceMappingURL=ToldTypes.d.ts.map
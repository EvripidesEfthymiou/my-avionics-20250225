 ...
 */
export declare class ToldUserSettings extends DefaultUserSettingManager<ToldUserSettingTypes> {
     ...
     */
    static getManager(bus: EventBus): DefaultUserSettingManager<ToldUserSettingTypes>;
    /**
     ...
     */
    static parseTakeoffResultString(resultString: string): ToldTakeoffPerformanceResult | undefined;
    /**
     ...
     * does not define such an object.
     */
    static parseLandingResultString(resultString: string): ToldLandingPerformanceResult | undefined;
}
//# sourceMappingURL=ToldUserSettings.d.ts.map
 ...
 */
export declare class TouchdownCalloutUserSettings extends DefaultUserSettingManager<TouchdownCalloutUserSettingTypes> {
    private static readonly ENABLED_SETTING_NAMES;
     ...
     */
    getEnabledSetting(altitude: GarminTawsVoiceCalloutAltitude): UserSetting<boolean>;
    /**
     ...
     */
    static getManager(bus: EventBus): TouchdownCalloutUserSettings;
}
//# sourceMappingURL=TouchdownCalloutSettings.d.ts.map
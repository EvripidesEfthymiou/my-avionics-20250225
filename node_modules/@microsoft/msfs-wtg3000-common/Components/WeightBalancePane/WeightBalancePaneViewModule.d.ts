...
export interface WeightBalancePaneViewModule {
     ...
     */
    renderAircraftLoadPanel(ref: NodeReference<WeightBalancePaneViewPanel>, bus: EventBus, weightBalanceConfig: WeightBalanceConfig, weightBalanceSettingManager: WeightBalanceUserSettingManager, unitsSettingManager: UnitsUserSettingManager): VNode;
}
//# sourceMappingURL=WeightBalancePaneViewModule.d.ts.map
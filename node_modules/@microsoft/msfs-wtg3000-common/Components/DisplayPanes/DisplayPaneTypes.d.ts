 ...
 */
export declare enum DisplayPaneIndex {
    LeftPfdInstrument = 0,
    LeftPfd = 1,
    LeftMfd = 2,
    RightMfd = 3,
 ...
 */
export declare enum DisplayPaneControlGtcIndex {
    LeftGtc = 1,
    RightGtc = 2
}
/**
 ...
 */
export declare enum DisplayPaneSizeMode {
    Full = "Full",
    Half = "Half",
    Hidden = "Hidden"
}
//# sourceMappingURL=DisplayPaneTypes.d.ts.map
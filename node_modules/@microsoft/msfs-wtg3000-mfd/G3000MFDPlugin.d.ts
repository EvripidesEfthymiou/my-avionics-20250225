...
import { DisplayPaneViewFactory, FlightPlanStore, G3000EspDefinition, G3000NavSourceName, G3000Plugin, G3000PluginBinder, InitializationProcess, ToldModule, WeightBalancePaneViewModule } from '@microsoft/msfs-wtg3000-common';
 ...
 */
export declare abstract class AbstractG3000MfdPlugin extends AvionicsPlugin<G3000MfdPluginBinder> implements G3000MfdPlugin {
    /** @inheritDoc */
    onInstalled(): void;
    /** @inheritDoc */
    onInit(): void;
    ...
    getStartupScreenRows(): readonly (StartupScreenRowFactory | StartupScreenPrebuiltRow)[] | undefined;
    /** @inheritDoc */
    getInitializationProcess(): InitializationProcess | undefined;
}
//# sourceMappingURL=G3000MFDPlugin.d.ts.map
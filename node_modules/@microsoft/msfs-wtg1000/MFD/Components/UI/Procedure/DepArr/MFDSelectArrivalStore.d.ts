 ...
 */
export declare class MFDSelectArrivalStore extends SelectArrivalStore {
    readonly transitionPreviewPlan: Subject<FlightPlan | null>;
}
//# sourceMappingURL=MFDSelectArrivalStore.d.ts.map
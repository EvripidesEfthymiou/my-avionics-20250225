import { ComponentProps, DisplayComponent, NodeReference, NumberUnitInterface, Subscribable, SubscribableArray, UnitFamily, UserSettingManager, UserSettingValueFilter, VNode } from '@microsoft/msfs-sdk';
 ...
 */
export declare abstract class MapSettingControl<K extends keyof MapUserSettingTypes, P extends MapSettingControlProps<K>> extends DisplayComponent<P> {
    protected readonly setting: import("@microsoft/msfs-sdk").UserSetting<NonNullable<MapUserSettingTypes[K]>>;
}
/**
 * A component which controls an on/off map setting.
 */
export declare class MapToggleSettingControl<K extends keyof UserSettingValueFilter<MapUserSettingTypes, boolean>> extends MapSettingControl<K, MapSettingControlProps<K>> {
    /** @inheritdoc */
    render(): VNode;
}
/**
 ...
 */
export declare class MapEnumSettingControl<K extends keyof MapUserSettingTypes> extends MapSettingControl<K, MapEnumSettingControlProps<K>> {
    /** @inheritdoc */
    render(): VNode;
}
/**
 ...
 */
export declare class MapRangeSettingControl<K extends keyof UserSettingValueFilter<MapUserSettingTypes, number>> extends MapSettingControl<K, MapRangeSettingControlProps<K>> {
    private static readonly NUMBER_FORMATTER;
    private readonly valuesSub;
    /** @inheritdoc */
    constructor(props: MapRangeSettingControlProps<K>);
    /**
     * A callback which is called when the map range values change.
     */
    private onMapRangesChanged;
    /**
...
//# sourceMappingURL=MapSettingControls.d.ts.map
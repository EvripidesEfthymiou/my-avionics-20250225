 ...
 */
export declare class G1000AirspeedIndicatorDataProvider extends DefaultAirspeedIndicatorDataProvider {
    /**
     ...
     */
    constructor(bus: EventBus, config: AirspeedIndicatorConfig);
}
//# sourceMappingURL=G1000AirspeedIndicatorDataProvider.d.ts.map
...
import { ToldTakeoffPerformanceResult, ToldUserSettingTypes, VSpeedGroup, VSpeedUserSettingManager } from '@microsoft/msfs-wtg3000-common';
 ...
 */
export declare class GtcTakeoffDataPageDataTab extends DisplayComponent<GtcTakeoffDataPageDataTabProps> implements GtcToldDataPageTabContent {
    ...
    private thisNode?;
    private readonly chkFlapsCssClass;
    private readonly rightCssClass;
    private readonly vSpeedValues;
    private readonly vSpeedFmsConfigMiscompareSettings;
    private readonly fmsConfigMiscompare;
    private readonly takeoffLengthAvailValue;
    private readonly takeoffLengthRequiredValue;
...
//# sourceMappingURL=GtcTakeoffDataPageDataTab.d.ts.map
 ...
 */
export declare class GtcNavComUtils {
    /**
     ...
     */
    static openPopup<T extends GtcView = GtcView>(gtcService: GtcService, key: string, popupType?: GtcPopupType, backgroundOcclusion?: GtcViewOcclusionType, fullIfVertical?: boolean): GtcViewEntry<T>;
    /**
     ...
     * place.
     */
    static closeVertNavComPopup<F extends GtcView = GtcView>(gtcService: GtcService, key: string, filter?: (popup: F) => boolean): boolean;
}
//# sourceMappingURL=GtcNavComUtils.d.ts.map
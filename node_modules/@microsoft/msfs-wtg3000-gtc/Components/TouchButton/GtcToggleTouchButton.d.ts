import { DisplayComponent, MutableSubscribable, Subscribable, VNode } from '@microsoft/msfs-sdk';
 ...
 */
export declare class GtcToggleTouchButton<S extends Subscribable<boolean> | MutableSubscribable<boolean>> extends DisplayComponent<GtcToggleTouchButtonProps<S>> {
...
//# sourceMappingURL=GtcToggleTouchButton.d.ts.map
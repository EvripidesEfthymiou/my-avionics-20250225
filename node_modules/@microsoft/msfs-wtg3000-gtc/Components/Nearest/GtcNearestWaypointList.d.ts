import { DisplayComponent, FacilityWaypoint, Subscribable, SubscribableArray, VNode } from '@microsoft/msfs-sdk';
...
import { GtcListProps } from '../List/GtcList';
import './GtcNearestWaypointList.css';
/**
 * Component props for GtcNearestWaypointList.
 */
export interface GtcNearestWaypointListProps<DataType extends NearestWaypointEntry<FacilityWaypoint> & DynamicListData = NearestWaypointEntry<FacilityWaypoint & DynamicListData>> extends Omit<GtcListProps<DataType>, 'sortItems' | 'data'> {
 ...
 */
export declare class GtcNearestWaypointList<DataType extends NearestWaypointEntry<FacilityWaypoint> & DynamicListData = NearestWaypointEntry<FacilityWaypoint & DynamicListData>> extends DisplayComponent<GtcNearestWaypointListProps<DataType>> implements GtcInteractionHandler {
    private static readonly RESERVED_CSS_CLASSES;
    private readonly listRef;
    private readonly noResultsCssClass;
    private cssClassSub?;
    private noResultsSub?;
    /** @inheritdoc */
    onAfterRender(): void;
    /**
...
//# sourceMappingURL=GtcNearestWaypointList.d.ts.map